...
validate_response('getConfig', 200, Body, ValidatorState) ->
...
validate_response('createNewUser', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('deleteUser', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('deleteUser', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('deleteUser', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getAllStatuses', 200, Body, ValidatorState) ->
    validate_response_body('ConnectionStatusList', 'ConnectionStatusList', Body, ValidatorState);
validate_response('getAllStatuses', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getAllStatuses', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getStatus', 200, Body, ValidatorState) ->
    validate_response_body('ConnectionStatus', 'ConnectionStatus', Body, ValidatorState);
validate_response('getStatus', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getStatus', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getUserInfo', 200, Body, ValidatorState) ->
    validate_response_body('User', 'User', Body, ValidatorState);
validate_response('getUserInfo', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getUserInfo', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getUserList', 200, Body, ValidatorState) ->
    validate_response_body('UserList', 'UserList', Body, ValidatorState);
validate_response('getUserList', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getUserList', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('loginUser', 200, Body, ValidatorState) ->
    validate_response_body('SuccessLogin', 'SuccessLogin', Body, ValidatorState);
...
request_params('getAllStatuses') ->
    [
        'users'
    ];
request_params('getStatus') ->
    [
        'user_name'
    ];
...
request_param_info('getConfig', 'app') ->
    #{
        source => qs_val,
        rules => [
            not_required
...
request_param_info('createNewUser', 'user_name') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('getAllStatuses', 'users') ->
    #{
        source => qs_val,
        rules => [
            required
...
request_param_info('getStatus', 'user_name') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('getUserInfo', 'user_name') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('getUserList', 'indexes') ->
    #{
        source => qs_val,
        rules => [
            not_required
...
request_param_info('loginUser', 'user_name') ->
    #{
        source => binding,
        rules => [
            {type, binary},
